...
#   v_s_private                   = module.vpc.private_subnets
#   v_kms_key_arn                 = module.system_manager.o_SSM-ManagedInstanceDataEncryptionKey_ARN
#   v_sns_arn                     = module.system_manager.o_SSM-SNS_ARN
#   v_automationExecutionRole     = module.system_manager.o_ssm-automationExecutionRole
...
#   v_ssm_eporting_dynamodb_table = var.v_monthly_patching_data
...
#   v_tag_handler_vpc_private_subnets                    = module.vpc.private_subnets
...
#   v_email_handler_vpc_private_subnets           = module.vpc.private_subnets
...
#   v_patch_completion_reagion                            = data.aws_region.current.name
#   v_patch_completion_function_name                      = var.v_pc_function_name
#   v_patch_completion_subnet_private                     = module.vpc.private_subnets
...
#   v_logs_portal_subnet_private                     = module.vpc.private_subnets
#   v_logs_portal_subnet_public                      = module.vpc.public_subnets
...
#   v_logs_portal_vpc_id                             = module.vpc.aws_vpc
...
#   v_logs_portal_api_gateway_vpc_endpoint_id        = module.vpc.aws_vpc_endpoint["r_api-gateway-endpoint"]
...
# #   # v_connection_lost_servers_vpc_private_subnets           = module.vpc.private_subnets
